        ...
        <form action="boardmodify" method="post">
         <div class="control-group">
            <div class="form-group floating-label-form-group controls">
              <h3>Update Board</h3>
              <hr>
              <label>Update Board</label>
              <table border="1">
				<tr>
					<th>NO</th>
					<td><input type="text" name="bno" value="${modify.bno}" readonly></td>
				</tr>
				<tr>
					<th>WRITE_DATE</th>
					<td>${modify.write_date}</td>
				</tr>
				<tr>
					<th>WRITER</th>
					<td><input type="text" value="${modify.writer}" readonly></td>
				</tr>
				<tr>
					<th>TITLE</th>
					<td><input type="text" value="${modify.title}" name="title"></td>
				</tr>
				<tr>
					<th>CONTENTS</th>
					<td><textarea name="contents">${modify.contents}</textarea></td>
				</tr>
				<tr>
					<th>CNT</th>
					<td>${modify.cnt}</td>
