    ...
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <h3>Password 인증번호</h3>  
         	 ...
         	 <form action="pass_injeung" method="post">
             <input type="text" class="form-control" placeholder="password key" name="pwkey" id="pwkey">
             <input type="hidden" name="dice" value="${dice}">
             <input type="hidden" name="email" value="${email}">
             <br>
            <button type="submit" class="btn btn-primary" id="pwfind">Enter</button>
